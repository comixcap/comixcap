...
A queueing-theory sandbox: distribute a case backlog across inspectors under five routing rules, reorder queues by drag-and-drop with live recalculation, run processing cycles and sampled reviews, then read the delay attribution to find out which stage actually caused the lateness.
